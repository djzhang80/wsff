                            ...
                            <form id="form" method="post" action="<?php echo U('del');?>">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="center"><a href="<?php echo U('edit',array('id'=>$val['id']));?>">修改</a>&nbsp;<a
                                                    class="del" href="javascript:;" val="<?php echo U('del',array('ids'=>$val['id']));?>"
                                                    title="删除">删除</a></td>
                                        </tr>
                                        <?php if(!empty($val["children"])): if(is_array($val["children"])): $i = 0; $__LIST__ = $val["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                                                    ...
                                                    <td><?php echo ($v['o']); ?></td>
                                                    <td class="center"><a href="<?php echo U('edit',array('id'=>$v['id']));?>">修改</a>&nbsp;<a
                                                            class="del" href="javascript:;"
                                                            val="<?php echo U('del',array('ids'=>$v['id']));?>" title="删除">删除</a></td>
                                                </tr>
                                                <?php if(!empty($v["children"])): if(is_array($v["children"])): $i = 0; $__LIST__ = $v["children"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td><?php echo ($vv['o']); ?></td>
                                                            <td class="center"><a
                                                                    href="<?php echo U('edit',array('id'=>$vv['id']));?>">修改</a>&nbsp;<a
                                                                    class="del" href="javascript:;"
                                                                    val="<?php echo U('del',array('ids'=>$vv['id']));?>" title="删除">删除</a>
                                                            </td>
