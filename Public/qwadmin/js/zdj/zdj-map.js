...
$(document).ready(function () {
    ...
    mymap.addLayer(osm);
    $.get("/wms/Public/geojson/watershed.json", function (data) {
    ...
    var rainIcon = L.icon({
        iconUrl: '/wms/Public/icon/rainguage.png',
        iconSize: [16, 16]
    });

    var hydIcon = L.icon({
        iconUrl: '/wms/Public/icon/hydguage.png',
        iconSize: [16, 16]
    });
    ...
    $.get("/wms/Public/geojson/monitorpoint.json", function (data) {
        var geolay = L.geoJSON(data, {
