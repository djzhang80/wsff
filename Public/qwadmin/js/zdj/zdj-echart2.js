...
function reloadflowChartf(pvar, guages, type) {
    var jqxhr = $.getJSON("/wms/qwadmin/HMS3/retrieveflowDataf", "id=" + pvar + "&guages=" + guages + "&type=" + type, function (data) {
...
function reloadpcpChartf(pvar, guages, type) {
    var jqxhr = $.getJSON("/wms/qwadmin/HMS3/retrievepcpDataf", "id=" + pvar + "&guages=" + guages + "&type=" + type, function (data) {
